  ...
  return (
    <div className={`bg-white border border-gray-200 rounded-lg p-6 hover:shadow-md transition-shadow duration-200 ${className}`}>
      <div className="flex flex-col items-center text-center">
        ...
        {/* User Info */}
        <Link href={`/profile/${user.id}`} className="mb-2">
        ...
        {isOwnProfile && (
          <Link
            ...
            className="w-full px-4 py-2 rounded-lg border border-primary-600 text-primary-600 hover:bg-primary-50 transition-colors duration-200 flex items-center justify-center space-x-2"
          >
