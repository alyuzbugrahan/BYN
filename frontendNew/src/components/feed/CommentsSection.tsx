...
import LoadingSpinner, { CommentSkeleton } from '../ui/LoadingSpinner';
      ...
      >
        ...
        <div className="flex-1 min-w-0">
          <div className="bg-gray-100 rounded-lg px-3 py-2 transition-all duration-200 group-hover:bg-gray-50">
            <div className="flex items-start justify-between">
              <div className="flex-1">
                <p className="text-sm font-medium text-gray-900 hover:text-primary-600 transition-colors duration-200">
                ...
                {isEditing ? (
                  <div className="mt-1 space-y-2">
                    <textarea
                      ...
                      className="w-full p-2 text-sm border border-gray-300 rounded focus:ring-primary-500 focus:border-primary-500 resize-none"
                      rows={2}
                      autoFocus
                    />
                    <div className="flex space-x-2">
                      <button
                        ...
                        className="px-3 py-1 text-xs bg-primary-500 text-white rounded hover:bg-primary-600 disabled:opacity-50 transition-colors duration-200"
                      >
                        Save
                      </button>
                      <button
          ...
          <div className="mt-2 flex items-center space-x-4 text-xs text-gray-500">
            <span className="hover:text-primary-600 transition-colors duration-200">
              {formatDistanceToNow(new Date(comment.created_at), { addSuffix: true })}
            </span>
            
            <button
              onClick={() => handleLikeComment(comment.id)}
              className={`flex items-center space-x-1 hover:text-primary-600 transition-all duration-200 ${
        ...
        <div className="flex-1">
          <div className="flex items-end space-x-2">
            <textarea
              ...
              className="flex-1 px-3 py-2 border border-gray-300 rounded-lg resize-none focus:ring-primary-500 focus:border-primary-500 transition-all duration-200"
              rows={1}
              onInput={(e) => {
            ...
            <button
              ...
              className="px-3 py-2 bg-primary-500 text-white rounded-lg hover:bg-primary-600 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200 transform hover:scale-105"
            >
              {submitting ? (
